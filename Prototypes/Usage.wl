...
MessageBlock::usage = "MessageBlock[expr,failexpr] suppresses all message output during the evaluation of 'expr'. If 'expr' generates messages, then 'failexpr' is evaluated without suppressing message output.";
